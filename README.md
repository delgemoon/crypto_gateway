...
├── src/                          # React frontend
│   ├── components/
│   │   ├── Dashboard/            # Trading panels, OrderForm, OpenOrders
│   │   ├── AggBook/              # Aggregated orderbook view
│   │   ├── AccountSummaryPanel/  # Equity & margin summary
│   │   ├── OrdersPanel/          # All-accounts orders view
│   │   ├── RfqPanel/             # CoInCall RFQ
│   │   ├── TelegramPanel/        # Telegram messaging
│   │   ├── WsManager/            # WS connection status panel
...
└── src-tauri/src/                # Rust backend
    ├── api/
    │   ├── models.rs             # All shared data types (incl. ReferenceData, VenueRef)
    │   ├── dispatch.rs           # Exchange-agnostic API router
    │   ├── deribit.rs            # Deribit REST
    │   ├── okx.rs                # OKX REST
    │   ├── bybit.rs              # Bybit REST
    │   ├── coincall.rs           # CoInCall REST + WS URL signing
    │   ├── binance.rs            # Binance REST
    │   ├── mexc.rs               # MEXC REST
    │   ├── hyperliquid.rs        # Hyperliquid REST
    │   └── uniswap.rs            # Uniswap on-chain (EVM RPC)
    ├── market/                   # Public market-data WebSocket tasks
    │   ├── mod.rs                # MarketDataManager
    │   ├── deribit.rs
    │   ├── okx.rs
    │   ├── bybit.rs
    │   └── coincall.rs
    ├── ws/                       # Private account WebSocket tasks
    │   ├── mod.rs                # WsManager
    │   ├── deribit.rs
    │   ├── okx.rs
    │   ├── bybit.rs
    ...
    │   ├── mexc.rs
    │   └── hyperliquid.rs
    ├── agg_book/                 # Aggregated orderbook engine
    ├── db/                       # SQLite schema + queries (accounts, settings, …)
    ├── telegram.rs               # Telegram Bot API client
    ├── rate_limiter.rs           # Per-exchange rate limiting
    ├── order_id.rs               # Client order ID encoding
    └── lib.rs                    # Tauri app entry, all command registrations
```
